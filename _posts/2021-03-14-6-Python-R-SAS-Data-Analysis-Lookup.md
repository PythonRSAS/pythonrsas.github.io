...
|                   | Run;                                                                                                                             |                                                              |                                      |
| output            | nan                                                                                                                              | nan                                                          | save()                               |
| content           | PROC CONTENT                                                                                                                     | nan                                                          | str(df)                              |
| nan               | nan                                                                                                                              | df.info(), df.dtypes                                         | nan                                  |
| summary           | PROC MEANS DATA=df NWAY; CLASS species; VAR x1-x6; RUN;                                                                          | df.describe()                                                | summary(dt)                          |
| nan               | PROC SUMMARY                                                                                                                     | df.x.describe()                                              | nan                                  |
| nan               | PROC SQL                                                                                                                         | pd.pivot_table()                                             | nan                                  |
| nan               | nan                                                                                                                              | df.groupby(by=’x’).sum()                                     | nan                                  |
| nan               | nan                                                                                                                              | df.groupby(by=’x’).count()                                   | nan                                  |
| nan               | nan                                                                                                                              | df.groupby(by=’x’).quantile([0.25,0.75])                     | nan                                  |
| nan               | nan                                                                                                                              | df.groupby(level=’ind1’)                                     | nan                                  |
| missing count     | PROC MEANS N NMISS MISSING;                                                                                                      | df.count()                                                   | nan                                  |
| nan               | nan                                                                                                                              | df.isnull().sum()                                            | nan                                  |
| nan               | PROC FREQ TABLE /MISSING;                                                                                                        | nan                                                          | nan                                  |
| frequency         | PROC FREQ                                                                                                                        | df.describe()                                                | nan                                  |
| nan               | PROC SQL                                                                                                                         | nan                                                          | nan                                  |
| nan               | nan                                                                                                                              | df.value.counts()                                            | nan                                  |
| nan               | nan                                                                                                                              | nan                                                          | nan                                  |
| nan               | nan                                                                                                                              | pd.crosstab(df.A, df.B).apply(lambda x: x/x.sum(), axis = 1) | nan                                  |
| distribution      | PROC UNIVARIATE                                                                                                                  | df.describe(include=[np.number])                             | nan                                  |
| drop/keep columns | DATA df (drop = col_name);                                                                                                       | df.drop(['x1', 'x2', 'x3'], axis = 1                         | nan                                  |
| nan               | nan                                                                                                                              | nan                                                          | nan                                  |
| nan               | DATA df (keep = col_name);                                                                                                       | df.loc[:, ['x1', 'x2'])                                      | nan                                  |
| rename            | DATA df (RENAME = (old=new col_name));                                                                                           | df.columns = ['name1', 'name2', 'name3']                     | nan                                  |
| sort              | PROC SORT; BY x1 DESCENDING x2;                                                                                                  | df.sort(['x1', 'x2'], ascending = [True, False])             | nan                                  |
| binning           | PROC RANK;                                                                                                                       | pd.cut(x, [min, cut1, …, cutk, max])                         | nan                                  |
| nan               | nan                                                                                                                              | nan                                                          | nan                                  |
| nan               | nan                                                                                                                              | np.digitize(x, [cut1, cut2, …, cutk])                        | nan                                  |
| nan               | nan                                                                                                                              | nan                                                          | nan                                  |
| nan               | nan                                                                                                                              | pd.qcut(df.x, n, labels=False)                               | nan                                  |
| bapping/          | DATA df;                                                                                                                         | df.x.replace(zip(old, new))                                  | nan                                  |
| replace value     | IF THEN;                                                                                                                         | nan                                                          | nan                                  |
| combine datasets  | DATA + MERGE;                                                                                                                    | pd.merge(df1, df2, how=’left’,on=’x’)                        | nan                                  |
| nan               | PROC SQL;                                                                                                                        | nan                                                          | nan                                  |
| filter join       | DATA + in;                                                                                                                       | df1[df1.x.isin(df2.x)]                                       | nan                                  |
| nan               | PROC SQL                                                                                                                         | df1[~df1.x.isin(df2.x)]                                      | nan                                  |
| get help          | nan                                                                                                                              | object ?                                                     | ?object                              |
| upgrade library   | nan                                                                                                                              | pip3 install --upgrade packageName --user                    | nan       
