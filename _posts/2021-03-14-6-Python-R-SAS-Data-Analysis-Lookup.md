...
|---:|:------------------|:---------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------|:-------------------------------------|
|  0 | input             | PROC IMPORT DATAFILE = " " OUT=df DBMS=CSV REPLACE; GUESSINGROWS=10000; RUN;                                                     | pd.read_csv(r”filename.csv”, encoding=”ISO-8859-1”) # encoding=”cp1252” | read.table(file, as.is=TRUE)         |
|    |                   |                                                                                                                                  | pd.read_sas(encoding=”latin-1” )                                        | read.csv("", header=TRUE)            |
|    |                   |                                                                                                                                  |                                                                         | load() # load data written with save |
|  1 | directory         | Filename filelist pipe "dir /b /s c:\temp\*.sas";                                                                                | import os                                                               | dir()                                |
|    |                   | Data _null_;                                                                                                                     | os.listdir("")                                                          |                                      |
|    |                   |   Infile filelist truncover;                                                                                                     |                                                                         |                                      |
|    |                   |   Input filename $100.;                                                                                                          |                                                                         |                                      |
|    |                   |   Put filename=;                                                                                                                 |                                                                         |                                      |
|    |                   | Run;                                                                                                                             |                                                                         |                                      |
|  2 | output            | nan                                                                                                                              | nan                                                                     | save()                               |
|  3 | content           | PROC CONTENT                                                                                                                     | nan                                                                     | str(df)                              |
|  4 | nan               | nan                                                                                                                              | df.info(), df.dtypes                                                    | nan                                  |
|  5 | summary           | PROC MEANS DATA=df NWAY; CLASS species; VAR x1-x6; RUN;                                                                          | df.describe()                                                           | summary(dt)                          |
|  6 | nan               | PROC SUMMARY                                                                                                                     | df.x.describe()                                                         | nan                                  |
|  7 | nan               | PROC SQL                                                                                                                         | pd.pivot_table()                                                        | nan                                  |
|  8 | nan               | nan                                                                                                                              | df.groupby(by=’x’).sum()                                                | nan                                  |
|  9 | nan               | nan                                                                                                                              | df.groupby(by=’x’).count()                                              | nan                                  |
| 10 | nan               | nan                                                                                                                              | df.groupby(by=’x’).quantile([0.25,0.75])                                | nan                                  |
| 11 | nan               | nan                                                                                                                              | df.groupby(level=’ind1’)                                                | nan                                  |
| 12 | missing count     | PROC MEANS N NMISS MISSING;                                                                                                      | df.count()                                                              | nan                                  |
| 13 | nan               | nan                                                                                                                              | df.isnull().sum()                                                       | nan                                  |
| 14 | nan               | PROC FREQ TABLE /MISSING;                                                                                                        | nan                                                                     | nan                                  |
| 15 | frequency         | PROC FREQ                                                                                                                        | df.describe()                                                           | nan                                  |
| 16 | nan               | PROC SQL                                                                                                                         | nan                                                                     | nan                                  |
| 17 | nan               | nan                                                                                                                              | df.value.counts()                                                       | nan                                  |
| 18 | nan               | nan                                                                                                                              | nan                                                                     | nan                                  |
| 19 | nan               | nan                                                                                                                              | pd.crosstab(df.A, df.B).apply(lambda x: x/x.sum(), axis = 1)            | nan                                  |
| 20 | distribution      | PROC UNIVARIATE                                                                                                                  | df.describe(include=[np.number])                                        | nan                                  |
| 21 | drop/keep columns | DATA df (drop = col_name);                                                                                                       | df.drop(['x1', 'x2', 'x3'], axis = 1                                    | nan                                  |
| 22 | nan               | nan                                                                                                                              | nan                                                                     | nan                                  |
| 23 | nan               | DATA df (keep = col_name);                                                                                                       | df.loc[:, ['x1', 'x2'])                                                 | nan                                  |
| 24 | rename            | DATA df (RENAME = (old=new col_name));                                                                                           | df.columns = ['name1', 'name2', 'name3']                                | nan                                  |
| 25 | sort              | PROC SORT; BY x1 DESCENDING x2;                                                                                                  | df.sort(['x1', 'x2'], ascending = [True, False])                        | nan                                  |
| 26 | binning           | PROC RANK;                                                                                                                       | pd.cut(x, [min, cut1, …, cutk, max])                                    | nan                                  |
| 27 | nan               | nan                                                                                                                              | nan                                                                     | nan                                  |
| 28 | nan               | nan                                                                                                                              | np.digitize(x, [cut1, cut2, …, cutk])                                   | nan                                  |
| 29 | nan               | nan                                                                                                                              | nan                                                                     | nan                                  |
| 30 | nan               | nan                                                                                                                              | pd.qcut(df.x, n, labels=False)                                          | nan                                  |
| 31 | bapping/          | DATA df;                                                                                                                         | df.x.replace(zip(old, new))                                             | nan                                  |
| 32 | replace value     | IF THEN;                                                                                                                         | nan                                                                     | nan                                  |
| 33 | combine datasets  | DATA + MERGE;                                                                                                                    | pd.merge(df1, df2, how=’left’,on=’x’)                                   | nan                                  |
| 34 | nan               | PROC SQL;                                                                                                                        | nan                                                                     | nan                                  |
| 35 | filter join       | DATA + in;                                                                                                                       | df1[df1.x.isin(df2.x)]                                                  | nan                                  |
| 36 | nan               | PROC SQL                                                                                                                         | df1[~df1.x.isin(df2.x)]                                                 | nan                                  |
| 37 | get help          | nan                                                                                                                              | object ?                                                                | ?object                              |
